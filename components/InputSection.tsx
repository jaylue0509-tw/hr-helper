...
import { Upload, FileText, Trash2, CheckCircle2, Wand2, AlertTriangle, Info, Building2, ChevronDown } from 'lucide-react';
...
export const InputSection: React.FC<InputSectionProps> = ({ onDataLoaded, currentCount }) => {
